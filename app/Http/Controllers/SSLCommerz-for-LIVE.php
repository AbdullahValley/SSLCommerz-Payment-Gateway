...
define("SSLCZ_STORE_ID", "LIVE-ID"); // It will provide by SSL COMMERZ
define("SSLCZ_STORE_PASSWD", "LIVE-PASSWORD"); // It will provide by SSL COMMERZ

# IF SANDBOX TRUE, THEN IT WILL CONNECT WITH SSLCOMMERZ SANDBOX (TEST) SYSTEM
define("SSLCZ_IS_SANDBOX", false); // TRUE for TEST & FALSE for LIVE

# IF BROWSE FROM LOCAL HOST, KEEP true
define("SSLCZ_IS_LOCAL_HOST", false); // TRUE for TEST & FALSE for LIVE
